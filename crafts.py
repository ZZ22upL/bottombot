...
def recipes():
    ...
    crafts = {
        ...
        "assebler-mk3": [[["v-6", 1], ["server", 1], ["engine-oil", 10], ["assebler-mk2", 3], ["cnc-mill", 3], ["titanium-alloy", 50], ["glass", 10], ["friend", 5]], 200, 1],
        "quary": [[["mining-system", 5], ["pressure-chamber", 5], ["iron-pick", 50], ["water", 50], ["friend", 50], ["vodka", 50]], 40, 1],
        "gold-ore": [[["quary", 1, False], ["engine-oil", 10]], 60, 100],
        "litium": [[["water", 100], ["quary", 1, False]], 90, 100],
        "acid": [[["water", 10], ["vodka", 1], ["assebler-mk3"], 10, 5],
        "uranium": [[["quary", 1], ["acid", 10]], 90, 100],
        "graphite": [[["coal", 20], ["pressure-chamber", 1, False]], 90, 2],
        "battery": [[["litium", 50], ["graphite", 10]], 30, 1],
        "diamond": [[["graphite", 10], ["assebler-mk3", 1, False], ["pressure-chamber", 1]], 300, 1],
        "vodka-level-2": [[["bottle", 100], ["organics", 100], ["pressure-chamber", 1, False]], 10, 100],
        "pipe": [[["assebler-mk3", 1, False], ["titanium-bar", 20]], 10, 10],
        ...
        "gold-wire": [[["assebler-mk3", 1, False], ["gold-bar", 10]], 10, 10],
        "high-speed-conector": [[[]]]
